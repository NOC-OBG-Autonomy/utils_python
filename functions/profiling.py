...
def find_profiles_by_depth(db, tsint=2, winsize=10):
    ...
    #find indexes correspond to surface behvior
    surfaces = find_surfacing(indices, depth, time_)

    #prepare the profiles indexes array
    profiles = []

    #Fill the array with the indexes between two inflextion points that does not correspond to a surfacing behavior
